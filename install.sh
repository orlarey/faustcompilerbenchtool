...
cp fcbenchtool fcmultibench fcplottool fccomparetool fcanalyzetool fcdebugtool fcasmtool fcspilltool fcautotool fcgentool multifaust fcexplorer.py fcbenchgraph.py fcanalyze.py fcoptimize.py fcspillgraph.py "$INSTALL_DIR"

chmod 755 "$INSTALL_DIR/fcbenchtool"
chmod 755 "$INSTALL_DIR/multifaust"
...
chmod 755 "$INSTALL_DIR/fcautotool"
chmod 755 "$INSTALL_DIR/fcgentool"
